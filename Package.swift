...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "DirectLine", url: "https://github.com/Master-Of-Code-Global/DirectLine", from: "0.1.1"),
    ...
    targets: [
        ...
        .target(
            name: "EmbeddableVoiceAssistant",
            dependencies: ["Introspect", "AdaptiveCardUI", "DirectLine", "Reachability"],
            resources: [
